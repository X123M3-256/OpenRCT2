...
namespace OpenRCT2
{
    enum : StringId
    {
        ...
        STR_RIDE_CONSTRUCTION_BOOSTER_BIDIRECTIONAL_TIP = 6713,
        STR_RIDE_CONSTRUCTION_BOOSTER_BRAKE_TIP = 6714,
        STR_RIDE_CONSTRUCTION_BLOCK_STOP_TIP = 6715,
        STR_RIDE_CONSTRUCTION_BLOCK_REVERSE_TIP = 6716,
        STR_RIDE_CONSTRUCTION_DELAY = 6717,
        STR_RIDE_CONSTRUCTION_DELAY_TIME = 6718,
        ...
        STR_TILE_INSPECTOR_TRACK_CLEAR_PREVIOUS_BLOCK = 6711,
