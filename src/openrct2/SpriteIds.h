...
enum : ImageIndex
{
    ...
    SPR_TRACKS_BM_TRACK_CORKSCREW_DIAGONAL = SPR_TRACKS_LATTICE_TRIANGLE_TRACK_CORKSCREW_DIAGONAL + 32,
    SPR_TRACKS_CORKSCREW_TRACK_CORKSCREW_DIAGONAL =  SPR_TRACKS_BM_TRACK_CORKSCREW_DIAGONAL + 32,

    SPR_TRACKS_END = SPR_TRACKS_CORKSCREW_TRACK_CORKSCREW_DIAGONAL + 32,
