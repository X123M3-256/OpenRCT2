...
enum : ImageIndex
{
    ...
    SPR_TRACKS_LATTICE_TRIANGLE_TRACK_LARGE_CORKSCREW_DIAGONAL = SPR_TRACKS_SINGLE_RAIL_GENTLE_DIAG_BRAKE + 4,
    SPR_TRACKS_BM_TRACK_LARGE_CORKSCREW_DIAGONAL = SPR_TRACKS_LATTICE_TRIANGLE_TRACK_LARGE_CORKSCREW_DIAGONAL + 40,
    SPR_TRACKS_CORKSCREW_TRACK_LARGE_CORKSCREW_DIAGONAL =  SPR_TRACKS_BM_TRACK_LARGE_CORKSCREW_DIAGONAL + 40,
    SPR_TRACKS_SINGLE_RAIL_TRACK_LARGE_CORKSCREW_DIAGONAL =  SPR_TRACKS_CORKSCREW_TRACK_LARGE_CORKSCREW_DIAGONAL + 40,

    SPR_TRACKS_CORKSCREW_TRACK_CORKSCREW_DIAGONAL = SPR_TRACKS_SINGLE_RAIL_TRACK_LARGE_CORKSCREW_DIAGONAL + 40,
    SPR_TRACKS_CORKSCREW_TRACK_HALF_LOOP_DIAGONAL = SPR_TRACKS_CORKSCREW_TRACK_CORKSCREW_DIAGONAL + 32,
    SPR_TRACKS_CORKSCREW_TRACK_VERTICAL_LOOP_DIAGONAL = SPR_TRACKS_CORKSCREW_TRACK_HALF_LOOP_DIAGONAL + 16,

    SPR_TRACKS_END = SPR_TRACKS_CORKSCREW_TRACK_VERTICAL_LOOP_DIAGONAL + 32,
