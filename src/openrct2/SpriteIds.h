...
enum : ImageIndex
{
    ...
    SPR_RIDE_DESIGN_PREVIEW_HYDRAULIC_LAUNCHED_ROLLER_COASTER_TRACK = SPR_TRACKS_SINGLE_RAIL_GENTLE_DIAG_BRAKE + 4,
    ...
    SPR_TRACKS_HYDRAULIC_LAUNCHED_BEGIN = SPR_RIDE_DESIGN_PREVIEW_HYDRAULIC_LAUNCHED_ROLLER_COASTER_TRACK + 2,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_FLAT = SPR_TRACKS_HYDRAULIC_LAUNCHED_BEGIN,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_GENTLE = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_FLAT + 2,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_STEEP = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_GENTLE + 12,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_VERTICAL = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_STEEP + 16,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_SMALL_CURVE = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_VERTICAL + 12,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_MEDIUM_CURVE = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_SMALL_CURVE + 12,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_LARGE_CURVE = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_MEDIUM_CURVE + 20,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_FLAT_DIAGONAL = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_LARGE_CURVE + 32,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_GENTLE_DIAGONAL = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_FLAT_DIAGONAL + 4,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_STEEP_DIAGONAL = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_GENTLE_DIAGONAL + 12,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_BANK_TRANSITION = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_STEEP_DIAGONAL + 12,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_BANK_TRANSITION_DIAGONAL = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_BANK_TRANSITION + 40,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_SMALL_CURVE_BANKED = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_BANK_TRANSITION_DIAGONAL + 34,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_MEDIUM_CURVE_BANKED = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_SMALL_CURVE_BANKED + 14,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_LARGE_CURVE_BANKED = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_MEDIUM_CURVE_BANKED + 22,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_GENTLE_SMALL_CURVE = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_LARGE_CURVE_BANKED + 32,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_GENTLE_MEDIUM_CURVE = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_GENTLE_SMALL_CURVE + 16,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_STEEP_SMALL_CURVE = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_GENTLE_MEDIUM_CURVE + 40,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_VERTICAL_TWIST = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_STEEP_SMALL_CURVE + 16,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_SLOPE_BANK_TRANSITION = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_VERTICAL_TWIST + 12,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_GENTLE_SMALL_CURVE_BANKED = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_SLOPE_BANK_TRANSITION
        + 64,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_GENTLE_MEDIUM_CURVE_BANKED
    = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_GENTLE_SMALL_CURVE_BANKED + 16,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_S_BEND = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_GENTLE_MEDIUM_CURVE_BANKED + 40,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_SMALL_HELIX = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_S_BEND + 16,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_LARGE_HELIX = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_SMALL_HELIX + 28,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_BARREL_ROLL = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_LARGE_HELIX + 44,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_HALF_LOOP = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_BARREL_ROLL + 48,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_FLAT_TO_STEEP = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_HALF_LOOP + 16,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_FLAT_TO_STEEP_DIAGONAL = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_FLAT_TO_STEEP + 32,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_QUARTER_LOOP = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_FLAT_TO_STEEP_DIAGONAL + 24,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_CORKSCREW = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_QUARTER_LOOP + 12,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_LARGE_CORKSCREW = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_CORKSCREW + 24,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_TURN_BANK_TRANSITION = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_LARGE_CORKSCREW + 40,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_MEDIUM_HALF_LOOP = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_TURN_BANK_TRANSITION + 18,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_LARGE_HALF_LOOP = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_MEDIUM_HALF_LOOP + 40,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_ZERO_G_ROLL = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_LARGE_HALF_LOOP + 56,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_LARGE_ZERO_G_ROLL = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_ZERO_G_ROLL + 32,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_DIVE_LOOP = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_LARGE_ZERO_G_ROLL + 40,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_SMALL_FLAT_TO_STEEP = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_DIVE_LOOP + 32,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_GENTLE_LARGE_CURVE = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_SMALL_FLAT_TO_STEEP + 20,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_GENTLE_LARGE_CURVE_BANKED = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_GENTLE_LARGE_CURVE + 64,

    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_BRAKE = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_GENTLE_LARGE_CURVE_BANKED + 128,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_BRAKE_DIAGONAL = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_BRAKE + 2,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_BLOCK_BRAKE = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_BRAKE_DIAGONAL + 2,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_BLOCK_BRAKE_DIAGONAL = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_BLOCK_BRAKE + 2,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_MAGNETIC_BRAKE = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_BLOCK_BRAKE_DIAGONAL + 2,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_MAGNETIC_BRAKE_GENTLE = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_MAGNETIC_BRAKE + 2,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_MAGNETIC_BRAKE_DIAGONAL = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_MAGNETIC_BRAKE_GENTLE + 4,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_MAGNETIC_BRAKE_GENTLE_DIAGONAL
    = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_MAGNETIC_BRAKE_DIAGONAL + 2,

    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRI_TRACK_BRAKE = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_MAGNETIC_BRAKE_GENTLE_DIAGONAL + 4,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRI_TRACK_BRAKE_DIAGONAL = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRI_TRACK_BRAKE + 2,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRI_TRACK_BLOCK_BRAKE = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRI_TRACK_BRAKE_DIAGONAL + 2,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRI_TRACK_BLOCK_BRAKE_DIAGONAL = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRI_TRACK_BLOCK_BRAKE + 2,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRI_TRACK_MAGNETIC_BRAKE = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRI_TRACK_BLOCK_BRAKE_DIAGONAL + 2,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRI_TRACK_MAGNETIC_BRAKE_GENTLE = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRI_TRACK_MAGNETIC_BRAKE + 2,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRI_TRACK_MAGNETIC_BRAKE_DIAGONAL
    = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRI_TRACK_MAGNETIC_BRAKE_GENTLE + 4,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRI_TRACK_MAGNETIC_BRAKE_GENTLE_DIAGONAL
    = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRI_TRACK_MAGNETIC_BRAKE_DIAGONAL + 2,

    SPR_TRACKS_HYDRAULIC_LAUNCHED_BI_TRACK_BRAKE = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRI_TRACK_MAGNETIC_BRAKE_GENTLE_DIAGONAL + 4,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_BI_TRACK_BRAKE_DIAGONAL = SPR_TRACKS_HYDRAULIC_LAUNCHED_BI_TRACK_BRAKE + 2,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_BI_TRACK_BLOCK_BRAKE = SPR_TRACKS_HYDRAULIC_LAUNCHED_BI_TRACK_BRAKE_DIAGONAL + 2,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_BI_TRACK_BLOCK_BRAKE_DIAGONAL = SPR_TRACKS_HYDRAULIC_LAUNCHED_BI_TRACK_BLOCK_BRAKE + 2,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_BI_TRACK_MAGNETIC_BRAKE = SPR_TRACKS_HYDRAULIC_LAUNCHED_BI_TRACK_BLOCK_BRAKE_DIAGONAL + 2,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_BI_TRACK_MAGNETIC_BRAKE_GENTLE = SPR_TRACKS_HYDRAULIC_LAUNCHED_BI_TRACK_MAGNETIC_BRAKE + 2,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_BI_TRACK_MAGNETIC_BRAKE_DIAGONAL
    = SPR_TRACKS_HYDRAULIC_LAUNCHED_BI_TRACK_MAGNETIC_BRAKE_GENTLE + 4,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_BI_TRACK_MAGNETIC_BRAKE_GENTLE_DIAGONAL
    = SPR_TRACKS_HYDRAULIC_LAUNCHED_BI_TRACK_MAGNETIC_BRAKE_DIAGONAL + 2,

    // Cable launch catch car
    SPR_TRACKS_CATCH_CAR_BEGIN = SPR_TRACKS_HYDRAULIC_LAUNCHED_BI_TRACK_MAGNETIC_BRAKE_GENTLE_DIAGONAL + 4,
    SPR_TRACKS_CATCH_CAR_END = SPR_TRACKS_CATCH_CAR_BEGIN + 4,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_CABLE_LAUNCH = SPR_TRACKS_CATCH_CAR_END,
    SPR_TRACKS_HYDRAULIC_LAUNCHED_END = SPR_TRACKS_HYDRAULIC_LAUNCHED_TRACK_CABLE_LAUNCH + 18,

    SPR_TRACKS_END = SPR_TRACKS_HYDRAULIC_LAUNCHED_END,
